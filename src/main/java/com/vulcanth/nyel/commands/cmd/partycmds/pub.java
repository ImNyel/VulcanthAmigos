...
public class pub extends SubCommand {

    public pub() {
        super("abrir", "abrir", "Abrir a party para qualquer jogador entre sem precisar de convite", false);
    }

    public pub(String name, String usage, String description, boolean onlyForPlayer) {
    ...
    public void perform(CommandSender sender, String[] args) {
        ...
        if (args.length == 0) {
            ...
            for (String playerNicks : party.getPlayers().keySet()) {
                ...
                ProxyServer.getInstance().getPlayer(playerNicks).sendMessage(TextComponent.fromLegacyText(ChatColor.RED + "A party tornou-se pública!"));
